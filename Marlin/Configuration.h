...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // A10M [@thinkyhead]
    ...
    #define DEFAULT_Kp_LIST { 50 }
    #define DEFAULT_Ki_LIST {  3 }
    #define DEFAULT_Kd_LIST {  7 }
  #else
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1000, 700, 15, 2000 }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { -9, (Y_MAX_POS - 3), 10 }
