 ...
 */
// A10M [@fishcu]
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.9, 79.9, 400, 413 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 15, 65 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1500, 1000, 15, 2000 }
 ...
 */
// @fishcu: Using a BLTouch clone from Triangle labs.
// #define BLTOUCH
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 47, 4, -1.6 }
...
// @fishcu: For dual gear extruders, have to invert all directions
...
//#define DEBUG_LEVELING_FEATURE
  ...
  // @fishcu: Setup with BL touch probe mounted on right side of hotend,
  // with this fan duct mod: https://www.thingiverse.com/thing:3332813
  // (includes a spacer of a few mm).
  // Since probe is on right and behind of hotend, can go very far left but not too far right 
  #define LEFT_PROBE_BED_POSITION (X_MIN_POS + X_PROBE_OFFSET_FROM_EXTRUDER + MIN_PROBE_EDGE)
  #define RIGHT_PROBE_BED_POSITION (X_MAX_POS - (MIN_PROBE_EDGE) - (X_MAX_POS%2))
  #define FRONT_PROBE_BED_POSITION (Y_MIN_POS + Y_PROBE_OFFSET_FROM_EXTRUDER + MIN_PROBE_EDGE)
  #define BACK_PROBE_BED_POSITION (Y_MAX_POS - (MIN_PROBE_EDGE) - (Y_MAX_POS%2))
...
// @fishcu: calibrated
// AB = 166.09
// XY_SKEW_FACTOR = 0.005773601
// #define SKEW_CORRECTION

#if ENABLED(SKEW_CORRECTION)
  // Input all length measurements here:
  #define XY_DIAG_AC 235.50
  #define XY_DIAG_BD 234.72
  #define XY_SIDE_AD 166.00

  // Or, set the default skew factors directly here
  // to override the above measurements:
  #define XY_SKEW_FACTOR 0.005773601
...
// :[0,1,2,3,4,5,6,7]
// @fishcu: scale by 1/2^SOFT_PWM_SCALE = 1/8, to get an effective PWM frequency of about 60Hz.
