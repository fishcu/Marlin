...
//#define LIN_ADVANCE
  ...
  #define LIN_ADVANCE_K 3.5    // Unit: mm compression per 1mm/s extruder speed
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_SLOW_LOAD_LENGTH   600  // (mm) Slow length, to allow time to insert material.
